    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "N/A", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "walkin@example.com", true, "Walk-in Customer", "0000000000", null },
                    { 2, "123 Main St, City", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "john.doe@example.com", true, "John Doe", "1234567890", null },
                    { 3, "456 Oak Ave, Town", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "jane.smith@example.com", true, "Jane Smith", "0987654321", null }
                });
